...
export const templates: ScriptTemplate[] = [
  // Fitness
  {
    ...
    description: 'Walking 10,000 steps every day for 30 days. Here is what changed.',
    script: "I walked 10,000 steps every day for 30 days straight, and the results completely surprised me. I thought I would just lose weight, but my sleep quality improved drastically, and my resting heart rate dropped by 8 beats per minute. If you think walking isn't real exercise, you are missing out on the easiest health hack ever.",
    defaults: {
  ...
  },
  {
    ...
    description: 'Why crunches are terrible for your back and what to do instead.',
    script: "Stop doing crunches immediately. You are literally destroying your lower back and pushing your posture out of alignment. If you want a strong core, you need to be doing anti-extension exercises like planks and dead bugs. Here is a 5-minute routine that is actually effective and won't leave you in pain.",
    defaults: {
      platform: 'TikTok',
      tone: 'Controversial',
      audience: 'Beginners',
  ...
  // Tech
  {
    ...
    script: "If your iPhone battery is draining way too fast, turn this hidden setting off right now. Go to Settings, Privacy, and scroll down to Analytics. Apple is constantly running diagnostics in the background, killing your battery life for no reason. Turn this off and watch your battery last an extra two hours every day.",
    defaults: {
      platform: 'TikTok',
      tone: 'Punchy',
      audience: 'Beginners',
  ...
  },
  {
    ...
    script: "I lost my entire life savings on my first business idea because I built something nobody actually wanted. I spent six months coding in secret instead of talking to a single customer. It was humiliating, but it taught me the most important lesson about business. Never build before you sell. Here is what I do differently now.",
    defaults: {
      platform: 'YouTube Shorts',
      tone: 'Story',
      audience: 'Creators',

...
export function ComparisonSection() {
  ...
  const copyHook = async (): Promise<void> => {
    await navigator.clipboard.writeText(hooklabAiExample.text);
    setCopied(true);
  };
